...
rpnConvertor (i:is) num stack 
    ...
    | i == "+"              = if (head stack == "(" || head stack == "*") then rpnConvertor is num (i:stack) else rpnConvertor is ((head stack):num) (i:(tail stack))
    | i == "*"              = if (head stack == "(") then rpnConvertor is num (i:stack) else rpnConvertor is ((head stack):num) (i:(tail stack))
